    ...
    public void gettingTheListViewForTheNavigationDrawerAndBindingItems() {
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        Intent intent = new Intent(TopNewsActivity.this, TopScienceNewsActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(TopNewsActivity.this, TopNewsActivity.class);
                        startActivity(intent1);

                        break;

                    case 2:
                        Intent intent2 = new Intent(TopNewsActivity.this, HealthNewsActivity.class);
