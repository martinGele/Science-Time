 ...
 */
public class ReadRssHealth extends AsyncTask<Void, Void, Void> {
    Context context;
    public static String address = "https://rss.sciencedaily.com/top/health.xml";
    ...
    public ReadRssHealth(Context context, RecyclerView recyclerView, ProgressBar bar) {
    ...
    public ReadRssHealth(Runnable runnable, RecyclerView recyclerView2) {
